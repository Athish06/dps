"""
Local development server for S-DES application.
Serves both the frontend static files and the API endpoint.
...
# S-DES Functions (copied from api/sdes.py for local dev)
...
if __name__ == '__main__':
    ...
    with socketserver.TCPServer(("", PORT), DevHandler) as httpd:
        print(f"S-DES Dev Server running at http://localhost:{PORT}")
