// Fermat's Little Theorem JavaScript
...
async function calculate() {
    ...
    if (isNaN(base) || isNaN(exponent) || isNaN(modulus) || modulus < 2) {
        alert('Please enter valid values (modulus must be ≥ 2)');
        return;
    }
    ...
    try {
        const response = await fetch(`${API_BASE}/api/math-ops`, {
            ...
            body: JSON.stringify({ operation: 'fermat', base, exponent, modulus })
        });
